...
<div class="bg-white rounded-lg shadow-lg p-6 mb-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <!-- Button untuk User melakukan peminjaman -->
        <div>
            <a href="{{ route('peminjaman.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition duration-300">
